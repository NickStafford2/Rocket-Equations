...
export function SceneHud({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-20">
      <div className="absolute left-5 top-24 flex max-w-[calc(100%-2.5rem)] flex-col gap-3">
        <div className="pointer-events-auto rounded-[1.4rem] border border-white/12 bg-[#07111f]/35 p-3 shadow-[0_24px_60px_rgba(0,0,0,0.24)] backdrop-blur-md">
          <div className="mb-3 text-[0.64rem] font-semibold tracking-[0.24em] text-white/70 uppercase">
            Mission
          </div>
